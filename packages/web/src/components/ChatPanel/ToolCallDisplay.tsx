      ...
      <div className="chat-tool-card animate-rise">
        ...
        >
          <div className="flex items-center gap-2">
            <span className="w-5 h-5 rounded bg-accent-2-subtle text-accent-2 flex items-center justify-center text-xs">
            ...
            <span className="font-mono text-sm font-medium text-text">{toolCall.name}</span>
  ...
  if (toolResult) {
    ...
    return (
      <div className="chat-tool-card animate-rise">
        ...
        {isExpanded && (
          <div className="mt-2 p-2 rounded-md bg-card border border-border">
            <pre className="font-mono text-xs text-text overflow-x-auto whitespace-pre-wrap max-h-60">
